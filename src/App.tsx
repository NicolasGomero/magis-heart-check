...
import SinDetallePage from "@/pages/SinDetallePage";
import BuenaObraEditPage from "@/pages/BuenaObraEditPage";
import BuenaObraDetallePage from "@/pages/BuenaObraDetallePage";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/obras/pecados/:id/detalle" element={<SinDetallePage />} />
