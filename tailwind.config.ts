...
export default {
  ...
  theme: {
    container: {
      ...
      padding: "1rem",
      screens: {
        "2xl": "430px", // Mobile-first, max width for phone
      },
    },
    extend: {
      colors: {
        ...
        // Custom state colors for examination
        state: {
          peace: "hsl(var(--state-peace))",
          attention: "hsl(var(--state-attention))",
          growth: "hsl(var(--state-growth))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      fontSize: {
        "ios-title": ["34px", { lineHeight: "41px", fontWeight: "700" }],
